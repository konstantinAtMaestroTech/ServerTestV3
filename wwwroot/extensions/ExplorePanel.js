...
export class ExplorePanel extends Autodesk.Viewing.UI.DockingPanel {
    ...
    updateStyles() {
        ...
        if (width <= smallScreenSize) {
            ...
            this.container.style.height = 180 + 'px';
            ...
            this.drawingsButton.style.height = 180 * 0.38 + 'px';
            this.drawingsButton.style.top = 180 * 0.57 + 'px';
            this.drawingsButton.style.left = 350 * 0.01 + 'px';
            this.instructionsButton.style.position = 'absolute';
            this.instructionsButton.style.width = 350 * 0.40 + 'px';
            this.instructionsButton.style.height = 180 * 0.38 + 'px';
            this.instructionsButton.style.top = 180 * 0.57 + 'px';
            ...
            this.drawingsButton.style.height = 200 * 0.38 + 'px';
            this.drawingsButton.style.top = 200 * 0.57 + 'px';
            this.drawingsButton.style.left = 400 * 0.01 + 'px';
            this.instructionsButton.style.position = 'absolute';
            this.instructionsButton.style.width = 400 * 0.40 + 'px';
            this.instructionsButton.style.height = 200 * 0.38 + 'px';
            this.instructionsButton.style.top = 200 * 0.57 + 'px';
